                ...
                <div>
                  ...
                  <p className="text-sm">
                    {initialData.patientRecord.base.registrationTime
                      ? new Date(Number(initialData.patientRecord.base.registrationTime) * 1000)
                          .toISOString()
                          .split("T")[0]
                      : "Unknown"}
                  </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mb-4">Healthcare service features will be available soon.</p>
              </div>
            </CardContent>
          </Card>
        </div>
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>Complete your patient registration with email verification</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Enter your wallet address</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Email Proof Content</label>
              <textarea
                value={emailContent}
          ...
          <div className="text-sm text-gray-500">
            <p>
              By registering, you agree to our terms of service and privacy policy. Your email will be cryptographically
              verified using vlayer technology.
            </p>
          </div>
        </CardContent>
      </Card>
