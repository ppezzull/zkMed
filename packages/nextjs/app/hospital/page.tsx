        ...
        <main className="relative min-h-screen bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl shadow-lg p-6 text-center">
              <h1 className="text-2xl font-bold text-white mb-2">Hospital Dashboard Unavailable</h1>
              <p className="text-gray-300">Unable to load hospital data</p>
            </div>
          </div>
        </main>
      );
      ...
      <main className="relative min-h-screen bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-300">Failed to load hospital data</p>
          </div>
        </div>
      </main>
    );
